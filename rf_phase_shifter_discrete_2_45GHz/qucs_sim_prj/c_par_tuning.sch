...
<Properties>
  <View=-733,-79,1752,985,1,867,0>
  <Grid=10,10,1>
  <DataSet=c_par_tuning.dat>
  <DataDisplay=c_par_tuning.dpl>
  <OpenDisplay=1>
  <Script=c_par_tuning.m>
  <RunScript=1>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <.SW SW2 1 740 10 0 67 0 0 "AC1" 1 "lin" 1 "c_par" 1 "1 pF" 1 "5 pF" 1 "11" 1>
  ...
  <Eqn L_serial_inductance 1 220 20 -34 16 0 0 "l_ser=2.2n" 1 "yes" 0>
</Components>
<Wires>
